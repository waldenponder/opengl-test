...
void createVAO(OUT GLuint& VAO, OUT GLuint& VBO)
{
	...
	glVertexAttribPointer(0, 3, GLfloat, GL_FALSE, 8 * FLOAT_SIZE, (void*)0);
	glEnableVertexAttribArray(0);
	glVertexAttribPointer(1, 2, GLfloat, GL_FALSE, 8 * FLOAT_SIZE, (void*)(3 * FLOAT_SIZE));
	glEnableVertexAttribArray(1);

	glVertexAttribPointer(2, 3, GLfloat, GL_FALSE, 8 * FLOAT_SIZE, (void*)(5 * FLOAT_SIZE));
